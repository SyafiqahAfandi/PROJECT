...
<head>
<meta charset="utf-8">
<title>S&F Resources | Admin Login</title>
...
<table width="312" height="391" border="1" align="center">
  <tbody>
    <tr bgcolor="#FFFFFF" style="text-align: center; font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif; font-style: bold;">
      <td width="296" height="385"><p><img src="image/admin.png" width="150" height="148" alt=""/></p>
      <p><strong>ADMIN LOGIN</strong></p>
      <form  id="form1" name="form1" method="post">
        <p>
          <input name="admin_username" type="text" required="required" id="textfield" placeholder="Username..">
        </p>
        <p>
...
$sql = "SELECT admin_username FROM admin
WHERE admin_username = '$admin_username' AND
admin_password = PASSWORD('$admin_password')";
$result = mysqli_query($conn, $sql);
$row = mysqli_fetch_assoc($result);

if (mysqli_num_rows($result) == 1) {
	echo '<script>window.location="../EmployeeSystem/admin/home.php"</script>';
} else {
...
?>
     ...
     <p> Doesn't have account ? <a href="register_admin.php">Sign Up</a> now !</p>
      <p><input type="back" value="BACK"  onclick="window.location.href='choose.php'"></p></td>
