...
$sql = "SELECT customer.cust_name,customer.cust_ic, customer.cust_phone, product.product_name FROM customer
INNER JOIN product ON customer.cust_ic=product.product_id";
if (isset($_POST['search'])) {
$searchname = $_POST['searchname'];
} else
$searchname = '';
$sql = $sql . " WHERE cust_name LIKE '%" . $searchname . "%' OR cust_ic LIKE '%" . $searchname . "%' OR product_name LIKE '%" . $searchname . "%' ";
...
<tbody>
  ...
  <tr> <p style="font-style: normal; font-weight: bold; text-align: center;"><img src="image/logo.jpeg" width="62" height="60" alt="" /></p>
    <p style="font-style: normal; font-weight: bold; text-align: center">LIST OF CUSTOMER</p>
    ...
    <table width="85%" height="107" align="center">
      <tr>
        <th width="21%">Name of Customer</th>
      ...
      <tr>
        ...
        <td><p>
          <input type="button" value="View Details" onclick="window.location.href='details_cust.php?cust_ic=<?php echo $row["cust_ic"] ?>'" />
        </p>
          </td>
        </tr>
      <?php
...
<p><a href=view_cust.php>Back</a></p>
</body>
</html>