...
FROM agent WHERE agent_ic='$user'";
  ...
  <tbody>
    <tr>
      <td height="115"><form id="form1" name="form1" method="post">
        ...
        <p style="font-style: normal; font-weight: bold; font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif;">UPDATE OF  AGENT</p>
        <p>
        ...
        <input type="submit" name="agentUpdate" value=" UPDATE "></span>        
        <p><a href="details_agent.php?agent_ic=<?php echo $row["agent_ic"] ?>">Back</a>
        <p>
          <?php
if (isset($_POST['agentUpdate'])){
...
$conn = mysqli_connect("localhost", "root", "", "Employee") or die (mysql_error ());
// SQL query
...
WHERE agent_ic =' $agent_ic '    ";
// Execute the query (the recordset $rs contains the result)
if (mysqli_query($conn, $sql)) {
echo "The record of agent is edited successfully";
} else {
