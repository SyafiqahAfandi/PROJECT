...
<table width="76%" border="1" align="center">
  <tbody>
    <tr style="text-align: center">
      <td><input type="button" value="EDIT" onclick="window.location.href='edit.php?staff_ic=<?php echo $row["staff_ic"] ?>'"></td>
      <td><input type="button" value="PRINT" onClick="javascript:window.print()"></td>
      <td><input type="button" value="BACK" onClick="window.location.href='view.php'">        </br></td>
    </tr>
  </tbody>
</table>
</div>
