  ...
  <tbody>
    <tr>
      <td height="115"><form id="form1" name="form1" method="post">
        ...
        <p style="font-style: normal; font-weight: bold;">DELETE PRODUCT DETAILS</p>
        <p>
        ...
        <p> <span style="text-align: center">
          ...
          <input name="product_price" type="text" value="<?php echo $product_price?>" id="product_price">
        </span></p>
        <p>
          <label for="textfield">Quantity &nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;</label>
          <input name="product_qty" type="text" value="<?php echo $product_qty?>" id="product_qty">
        </p>
        <p>&nbsp;</p>
        <p>
        ...
        <p>&nbsp;</p><span style="text-align: center"></br>
          </br>
          <input type="submit" name="productDelete" value=" DELETE ">
    	  <p><a href="../admin/details_product.php?product_id=<?php echo $row["product_id"] ?>">Back</a>
        <p>
          <?php
...
echo "The record of product is deleted successfully";
} else {
