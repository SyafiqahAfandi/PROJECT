...
<form method="post" action="<?php echo $_SERVER['PHP_SELF']?>?staff_username=<?php echo $staff_username?>">
  ...
  <p style="font-style: normal; font-weight: bold;">DELETE STAFF DETAILS</p>
...
<label for="textfield5">District :</label>
  ...
  <p>
    <label for="textfield6"><span style="text-align: justify">State</span> :</label>
    <span style="text-align: center">
    <input name="staff_district2" type="text" value="<?php echo $staff_state?>">
    </span>    </p>
  <p style="text-align: center">
